...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        page.get_by_text("Fixture active conversation").wait_for()
        assert page.get_by_text("fixture-active-thread").is_visible()
        assert page.get_by_text("fixture-archived-thread").is_visible()
        assert page.get_by_text("Archived", exact=True).is_visible()
