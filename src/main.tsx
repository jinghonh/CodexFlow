...
function App() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="side-group"><span className="side-caption">工作空间</span><div className="side-link active"><span className="side-dot" />来源与分析连接 <span className="side-index">01</span></div><a className="side-link" href="#sessions"><span className="side-dot" />会话列表 <span className="side-index">02</span></a></div>
      <div className="side-note"><span className="side-note-line" />本机持久会话会保存到应用缓存。Jev 关系分析服务可单独配置，项目分析由后续流程手动启动。</div>
